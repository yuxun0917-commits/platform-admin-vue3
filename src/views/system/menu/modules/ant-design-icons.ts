/**
 * Ant Design 图标名常量（来自 iconify `ant-design` 集合，共 848 个）。
 * 完整 iconify 图标名 = `ant-design:${name}`，如 `ant-design:user-outlined`。
 * 由 iconify 公共 API 生成，用于菜单图标选择器。
 */
export const ANT_DESIGN_ICONS: string[] = [
  'account-book-filled',
